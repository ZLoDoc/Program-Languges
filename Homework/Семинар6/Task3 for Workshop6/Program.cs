// Задача 6семинар - необязательная: Напишите программу, на вход которой подаётся прямоугольная матрица
//  в виде последовательности строк. После последней строки матрицы идёт строка, содержащая только строку
//   "end" (без кавычек, см. Sample Input).
...
int[,]CreatArray()
{
Console.Write("Введите первую строку матрицы :");
